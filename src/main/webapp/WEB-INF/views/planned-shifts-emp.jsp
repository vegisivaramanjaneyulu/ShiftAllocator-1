...
<html lang="en">
  <head>
    ...
    <title>Shift Allocator - Planned Shifts</title>
    <!-- Bootstrap -->
	...
	<script type="text/javascript" src="<c:url value='/resources/js/shift-allocator.js' />"></script>
  ...
  <div class="header">
        	...
        	<div class="row">
                ...
                <div class="col-md-7">
                    <ul class="header_nav">
                      ...
                      <li><a href="<c:url value="/get-planned-shifts-emppage" />" class="header_nav_active">Planned Shifts</a></li>
                    
                    </ul>
                </div>
                <div class="col-md-1 right">
					<a href="/ShiftAllocator/user/logOff" class="login_out">Logout</a>
                </div>
            </div>
        </div>
    </div> 
	...
	<div class="container main_container">
		...
		<div class="col-md-12">
			<form class="form-horizontal" role="form" autocomplete="off" onchange="getShiftData()">
				...
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							...
							<div class="col-md-9">
								<select class="form-control" id="month-form">
